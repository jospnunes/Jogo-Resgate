...
function start() {
    ...
    //  move o inimigo 1, helicóptero amarelo
    ...
    // verifica a colisão dos itens do jogo
    function colisao() {
    ...
    // explosão, colisão com o inimigo 1, helicóptero
    ...
    //  explosão, colisão com o inimigo 2, caminhão
    ...
    // explosão, colisão do amigo com inimigo 2, caminhão
    ...
    // soma a pontuação do jogo
    function placar() {
        $("#placar").html("<h2> Pontos: " + pontos + " Salvos: " + salvos + " Perdidos: " + perdidos + "</h2>");
    }

    // avalia a energia (vida) do jogador, helicóptero cinza
    function energia() {
        if (energiaAtual == 3) {
    ...
    // avalia o fim de jogo, game over
	function gameOver() {
        fimdejogo = true;
        musica.pause();
        somGameover.play();
